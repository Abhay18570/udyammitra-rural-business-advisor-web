...
export function LandingFooter() {
  ...
  return <footer className="portal-footer"><div className="portal-container portal-footer__grid"><div><Link className="portal-footer-brand" to="/"><UdyamMitraLogo variant="transparent" size="small" decorative />UdyamMitra</Link><p>{text('Rural Business Advisory Platform')}</p><p>{text(m.independent.en)}</p></div>
